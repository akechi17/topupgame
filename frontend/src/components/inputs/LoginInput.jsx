...
const LoginInput = ({ label, icon, showeye, name, innerRef }) => {
  ...
  return (
    <div className={`input-div mb-4 grid-cols-10 ${isFocus ? "focus" : ""}`}>
      <div className='col-span-1 flex justify-center items-center text-gray dark:text-lightOne transition duration-300'>
      ...
      <div className='col-span-1 flex justify-center items-center'>
        {showeye && (
          <button type='button' onClick={togglePasswordVisibility}>
            <Icon
              className='text-gray dark:text-lightOne'
              icon={
                isPasswordVisible
